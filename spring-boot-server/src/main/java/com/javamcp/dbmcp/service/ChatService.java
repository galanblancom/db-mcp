...
import com.javamcp.dbmcp.model.QueryResult;
import com.javamcp.dbmcp.model.TableListItem;
...
public class ChatService {
    ...
    private final Optional<OpenAIChatService> openAIChatService;

    @Autowired
    public ChatService(McpService mcpService, DatabaseService databaseService, Optional<OpenAIChatService> openAIChatService) {
    ...
    public String processMessage(String userMessage) {
        ...
        if (openAIChatService.isPresent()) {
            try {
                OpenAIChatService.ChatResult result = openAIChatService.get().chat(userMessage);
