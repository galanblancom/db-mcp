...
import com.javamcp.dbmcp.model.openai.FunctionDefinition.FunctionParameters;
import com.javamcp.dbmcp.model.openai.FunctionDefinition.PropertyDefinition;
...
public class FunctionCallHandler {
    ...
    public Object executeFunction(String functionName, Map<String, Object> arguments) throws Exception {
        ...
        switch (functionName) {
            case "runQuery":
                return mcpToolService.runQuery(objectMapper.convertValue(arguments, com.javamcp.dbmcp.model.request.QueryRequest.class));
